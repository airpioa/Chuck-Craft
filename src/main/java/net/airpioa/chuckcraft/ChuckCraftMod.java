package net.airpioa.chuckcraft;
...
@Mod("chuck_craft")
public class ChuckCraftMod {
	public static final Logger LOGGER = LogManager.getLogger(ChuckCraftMod.class);
	public static final String MODID = "chuck_craft";

	public ChuckCraftMod(IEventBus modEventBus) {
